JAZZMIN_SETTINGS = {
    ...
    "site_logo": "static/images/razrabotchik.png",

    "login_logo": 'static/images/razrabotchik.png',

    "login_logo_dark": True,

    "site_logo_classes": "images-circle",

    "site_icon": 'static/images/razrabotchik.png',

    "welcome_sign": "Welcome to the OnlineBookAdmin",
